    ...
    <div class="container mx-auto flex justify-between items-center">
      ...
      <nav id="nav-menu" class="hidden xl:block">
        <ul class="flex flex-col xl:flex-row xl:space-x-6 bg-[#115D5B] xl:bg-transparent xl:static absolute left-0 top-full w-full xl:w-auto p-4 xl:p-0 shadow-md xl:shadow-none">
          <li><a href="index.html" class="text-white xl:text-black font-bold hover:text-gray-300 block py-2">Home</a></li>
          ...
          <li><a href="elibrary.html" class="text-white xl:text-black font-bold bg-green-1000 px-4 py-2 rounded-lg hover:text-gray-300 block py-2">Library</a></li>
          <li><a href="account.html" class="text-white xl:text-black font-bold bg-green-900 px-6 py-2 rounded-lg hover:text-gray-300 block py-2">Log In</a></li>
        </ul>
      </nav>
    </div>
  </header>
